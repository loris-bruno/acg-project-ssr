...
layout(shared, binding=2) buffer DispatchIndirectCommandData
{     
...
const Eng::Ssbo ENG_API& Eng::PipelineGeometry::getWorkgroupCount() const
{
   return reserved->workgroupCount;
}
...
bool ENG_API Eng::PipelineGeometry::init()
{
   ...
   reserved->workgroupCount.create(sizeof(Eng::PipelineRayTracing::DispatchIndirectCommand));
...
{	
   ...
   reserved->rayBufferCounter.reset();
   reserved->rayBufferCounter.render(1);
   reserved->workgroupCount.render(2);
